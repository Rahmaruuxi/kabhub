      ...
      <div className="relative bg-gradient-to-r from-[#136269] to-[#1a7982] overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div 
            ...
            style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='2' height='2' fill='%23ffffff' fill-opacity='0.4' x='0' y='0'/%3E%3C/svg%3E")`,
